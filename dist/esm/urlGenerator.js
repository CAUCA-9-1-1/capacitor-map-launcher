...
export function generateMarkerUrl(mapType, coords, title, description, zoom = 16) {
    switch (mapType) {
        case MapType.GOOGLE:
            return buildUrl(Capacitor.getPlatform() === 'ios' ? 'comgooglemaps://' : 'geo:0,0', {
        ...
        case MapType.AMAP:
            return buildUrl(`${Capacitor.getPlatform() === 'ios' ? 'ios' : 'android'}amap://viewMap`, {
